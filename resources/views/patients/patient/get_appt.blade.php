...
@section('content')
    ...
    @can('appointment_patient_create')
        <p>
            <a href="{{ route('admin.appointments.create_appt') }}" class="btn btn-success">Add New</a>
        </p>
    @endcan
                    ...
                    @if (count($appointments) > 0)
                        @foreach ($patient_appointments as $appointment)
                            <tr data-entry-id="{{ $appointment->id }}">
                                ...
                                <td>
                                    @can('appointment_patient_view')
                                        <a href="{{ route('admin.appointments.show_appt',[$appointment->id]) }}"
                                        class="btn btn-xs btn-primary">View</a>
                                    @endcan
                                    @can('appointment_patient_edit')
                                        <a href="{{ route('admin.appointments.edit_appt',[$appointment->id]) }}"
                                    ...
                                    @can('appointment_patient_delete')
                                        ...
                                        {!! Form::submit(trans('Cancel'), array('class' => 'btn btn-xs btn-danger')) !!}
                                        {!! Form::close() !!}
                                    @endcan
                                </td>
                            </tr>
